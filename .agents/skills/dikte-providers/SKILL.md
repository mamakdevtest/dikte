...
- Built-ins: local, local-llm, deepgram, Codex, codex, antigravity.
...
- Assistant: `assistant.ask` → Codex/codex/antigravity/plain-HTTP gateway.
...
4. Third-party config reads stay narrow by design: Codex settings.json only
